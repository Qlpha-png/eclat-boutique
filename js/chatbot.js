...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const KB = {
        fr: {
            ...
            responses: {
                ...
                acne: {
                    ...
                    answer: '<strong>Routine anti-acné ÉCLAT :</strong><br><br>1. <strong>Brosse Nettoyante Sonic</strong> (29,90€) — nettoyage profond sans agresser<br>2. <strong>Scrubber Ultrasonique</strong> (34,90€) — désincruste les pores en douceur<br>3. <strong>Masque LED Pro</strong> (49,90€) — lumière bleue anti-bactérienne<br><br><a href="pages/guide-beaute.html#led" style="color:var(--color-secondary);">Lire l\'étude clinique →</a>',
                ...
                wrinkles: {
                    ...
                    answer: '<strong>Routine anti-âge ÉCLAT :</strong><br><br>1. <strong>Sérum Vitamine C 20%</strong> (19,90€) — stimule le collagène<br>2. <strong>Masque LED Pro</strong> (49,90€) — lumière rouge régénérante<br>3. <strong>Stickers Anti-Rides Nuit</strong> (17,90€) — lisse pendant le sommeil<br><br><a href="pages/guide-beaute.html#vitc" style="color:var(--color-secondary);">Voir l\'étude Vitamine C →</a>',
                    followUp: ['Ajouter le Sérum', 'Voir les Stickers', 'Faire le diagnostic']
                },
                hydration: {
                    match: ['sèche', 'sec ', 'déshydrat', 'hydrat', 'tiraille', 'confort'],
                    answer: '<strong>Routine hydratation intense :</strong><br><br>1. <strong>Facial Steamer Nano-Ion</strong> (29,90€) — ouvre les pores, prépare la peau<br>2. <strong>Huile Précieuse Rose Musquée</strong> (16,90€) — nourrit en profondeur<br>3. <strong>Patchs Yeux Collagène</strong> (12,90€) — hydratation ciblée contour des yeux<br><br><a href="pages/guide-beaute.html#rosehip" style="color:var(--color-secondary);">La science de la Rose Musquée →</a>',
                ...
                darkcircles: {
                    ...
                    answer: '<strong>Solution cernes & poches :</strong><br><br>1. <strong>Ice Roller Cryo</strong> (9,90€) — dégonfle instantanément<br>2. <strong>Patchs Yeux Collagène</strong> (12,90€) — hydrate + lisse le contour<br>3. <strong>Masque Yeux Vapeur SPA</strong> (9,90€) — relaxe et décongestionne<br><br>Total : seulement <strong>32,70€</strong> pour une routine complète !<br><a href="pages/guide-beaute.html#cryo" style="color:var(--color-secondary);">La science de la cryothérapie →</a>',
                ...
                glow: {
                    ...
                    answer: '<strong>Routine éclat & luminosité :</strong><br><br>1. <strong>Sérum Vitamine C 20%</strong> (19,90€) — antioxydant, anti-taches<br>2. <strong>Gua Sha Quartz Rose</strong> (14,90€) — booste la microcirculation<br>3. <strong>Masque Collagène Lifting</strong> (14,90€) — coup d\'éclat immédiat<br><br><a href="pages/guide-beaute.html#guasha" style="color:var(--color-secondary);">Étude : Gua Sha +400% microcirculation →</a>',
                    followUp: ['Ajouter le Gua Sha', 'Voir le Sérum', 'Faire le diagnostic']
                },
                firming: {
                    match: ['rafferm', 'ovale', 'mâchoire', 'double menton', 'tonif', 'sculpt'],
                    answer: '<strong>Routine raffermissante :</strong><br><br>1. <strong>V-Line Roller EMS</strong> (24,90€) — micro-courants tonifiants<br>2. <strong>Gua Sha Quartz Rose</strong> (14,90€) — sculpte l\'ovale du visage<br>3. <strong>Masque LED Pro</strong> (49,90€) — lumière rouge pour la fermeté<br><br><a href="pages/guide-beaute.html#ems" style="color:var(--color-secondary);">Étude : EMS +18,6% épaisseur musculaire →</a>',
                    followUp: ['Ajouter le V-Line', 'Comment ça marche ?', 'Faire le diagnostic']
                },
                sensitivity: {
                    match: ['sensib', 'réactiv', 'rougeur', 'irritat', 'doux', 'douce', 'apais'],
                    answer: '<strong>Pour les peaux sensibles :</strong><br><br>1. <strong>Ice Roller Cryo</strong> (9,90€) — apaise les rougeurs par le froid<br>2. <strong>Huile Précieuse Rose Musquée</strong> (16,90€) — régénère sans irriter<br>3. <strong>Facial Steamer Nano-Ion</strong> (29,90€) — vapeur douce, pas de friction<br><br>Tous nos outils sont <strong>non invasifs</strong> et adaptés aux peaux réactives.',
                ...
                shipping: {
                    ...
                    answer: 'Nous livrons dans toute l\'<strong>Europe</strong> :<br><br>• <strong>Standard</strong> : 7-14 jours ouvrés — <strong>gratuit dès 49€</strong><br>• <strong>Express</strong> : 5-10 jours ouvrés — 7,90€<br>• Suivi de commande inclus<br>• Pas de frais de douane dans l\'UE',
                ...
                bestseller: {
                    ...
                    answer: 'Nos 3 best-sellers :<br><br>1. <strong>Masque LED Pro 7 Couleurs</strong> (49,90€) — anti-âge + anti-acné<br>2. <strong>Gua Sha Quartz Rose</strong> (14,90€) — drainage + éclat<br>3. <strong>Ice Roller Cryo</strong> (9,90€) — anti-poches, anti-rougeurs<br><br>Tous validés par des études cliniques.',
                ...
                order: {
                    ...
                    answer: 'C\'est simple :<br><br>1. Ajoutez vos produits au panier<br>2. Cliquez sur <strong>Commander</strong><br>3. Réglez en toute sécurité via Stripe<br><br>Pas besoin de créer un compte ! Livraison gratuite dès 49€.',
                ...
                price: {
                    ...
                    answer: 'Nos prix :<br><br>• À partir de <strong>9,90€</strong> (Ice Roller, Masque Yeux SPA)<br>• Jusqu\'à <strong>49,90€</strong> (Masque LED Pro)<br>• Livraison <strong>gratuite dès 49€</strong><br><br>Des coffrets existent pour économiser !',
        ...
        en: {
            ...
            responses: {
                acne: { match: ['acne', 'breakout', 'pimple', 'blackhead', 'pore', 'oily'], answer: '<strong>ÉCLAT anti-acne routine:</strong><br><br>1. <strong>Sonic Cleansing Brush</strong> (29.90€) — deep cleanse<br>2. <strong>Ultrasonic Scrubber</strong> (34.90€) — gentle pore extraction<br>3. <strong>LED Mask Pro</strong> (49.90€) — blue light kills bacteria<br><br><a href="pages/guide-beaute.html#led" style="color:var(--color-secondary);">Read the clinical study →</a>', followUp: ['Add LED Mask', 'How does LED work?', 'Take the quiz'] },
                wrinkles: { match: ['wrinkle', 'anti-aging', 'aging', 'firm', 'collagen', 'lifting'], answer: '<strong>ÉCLAT anti-aging routine:</strong><br><br>1. <strong>Vitamin C Serum 20%</strong> (19.90€) — collagen boost<br>2. <strong>LED Mask Pro</strong> (49.90€) — red light therapy<br>3. <strong>Night Anti-Wrinkle Stickers</strong> (17.90€) — smooths overnight<br><br><a href="pages/guide-beaute.html#vitc" style="color:var(--color-secondary);">See Vitamin C study →</a>', followUp: ['Add Serum', 'See Stickers', 'Take the quiz'] },
                hydration: { match: ['dry', 'dehydrat', 'hydrat', 'tight', 'moisture'], answer: '<strong>Intense hydration routine:</strong><br><br>1. <strong>Facial Steamer Nano-Ion</strong> (29.90€) — opens pores, preps skin<br>2. <strong>Rosehip Oil</strong> (16.90€) — deep nourishment<br>3. <strong>Collagen Eye Patches</strong> (12.90€) — targeted hydration<br><br><a href="pages/guide-beaute.html#rosehip" style="color:var(--color-secondary);">The science of Rosehip →</a>', followUp: ['Add Steamer', 'See Rosehip Oil', 'Take the quiz'] },
                darkcircles: { match: ['dark circle', 'puffy', 'eye bag', 'under eye', 'tired'], answer: '<strong>Dark circles & puffiness solution:</strong><br><br>1. <strong>Ice Roller Cryo</strong> (9.90€) — instant de-puff<br>2. <strong>Collagen Eye Patches</strong> (12.90€) — hydrate + smooth<br>3. <strong>Steam Eye Mask SPA</strong> (9.90€) — relax + decongest<br><br>Total: only <strong>32.70€</strong>!', followUp: ['Add Ice Roller', 'See Patches', 'Take the quiz'] },
                glow: { match: ['dull', 'glow', 'bright', 'radianc', 'dark spot', 'pigment', 'uneven'], answer: '<strong>Glow & radiance routine:</strong><br><br>1. <strong>Vitamin C Serum 20%</strong> (19.90€) — antioxidant, brightening<br>2. <strong>Rose Quartz Gua Sha</strong> (14.90€) — boosts microcirculation<br>3. <strong>Collagen Lifting Mask</strong> (14.90€) — instant glow<br><br><a href="pages/guide-beaute.html#guasha" style="color:var(--color-secondary);">Study: Gua Sha +400% circulation →</a>', followUp: ['Add Gua Sha', 'See Serum', 'Take the quiz'] },
                firming: { match: ['firm', 'jawline', 'double chin', 'tone', 'sculpt', 'sag'], answer: '<strong>Firming routine:</strong><br><br>1. <strong>V-Line EMS Roller</strong> (24.90€) — microcurrent toning<br>2. <strong>Rose Quartz Gua Sha</strong> (14.90€) — sculpts facial contour<br>3. <strong>LED Mask Pro</strong> (49.90€) — red light for firmness<br><br><a href="pages/guide-beaute.html#ems" style="color:var(--color-secondary);">Study: EMS +18.6% muscle thickness →</a>', followUp: ['Add V-Line', 'How does it work?', 'Take the quiz'] },
                sensitivity: { match: ['sensitiv', 'reactiv', 'redness', 'irritat', 'gentle', 'calm'], answer: '<strong>For sensitive skin:</strong><br><br>1. <strong>Ice Roller Cryo</strong> (9.90€) — soothes redness with cold<br>2. <strong>Rosehip Oil</strong> (16.90€) — regenerates without irritation<br>3. <strong>Facial Steamer Nano-Ion</strong> (29.90€) — gentle steam, no friction<br><br>All non-invasive, suitable for reactive skin.', followUp: ['Add Ice Roller', 'See Rosehip Oil', 'Take the quiz'] },
                ...
                shipping: { match: ['shipping', 'delivery', 'how long', 'ship', 'send'], answer: 'We ship across <strong>Europe</strong>:<br><br>• <strong>Standard</strong>: 7-14 business days — free from 49€<br>• <strong>Express</strong>: 5-10 business days — 7.90€<br>• Tracking included<br>• No customs fees within the EU', followUp: ['Returns?', 'Payment?', 'Track my order'] },
                ...
                bestseller: { match: ['best-seller', 'popular', 'best', 'top sell'], answer: 'Our top 3 best-sellers:<br><br>1. <strong>LED Mask Pro 7 Colors</strong> (49.90€)<br>2. <strong>Rose Quartz Gua Sha</strong> (14.90€)<br>3. <strong>Ice Roller Cryo</strong> (9.90€)<br><br>All backed by clinical studies.', followUp: ['See LED Mask', 'See Gua Sha', 'Take the quiz'] },
        ...
        es: {
            ...
            responses: {
                acne: { match: ['acné', 'grano', 'imperfección', 'punto negro', 'poro', 'grasa'], answer: '<strong>Rutina anti-acné ÉCLAT:</strong><br><br>1. <strong>Cepillo Sónico</strong> (29,90€) — limpieza profunda<br>2. <strong>Scrubber Ultrasónico</strong> (34,90€) — extracción suave<br>3. <strong>Mascarilla LED Pro</strong> (49,90€) — luz azul antibacteriana<br><br><a href="pages/guide-beaute.html#led" style="color:var(--color-secondary);">Ver estudio clínico →</a>', followUp: ['Añadir Mascarilla LED', '¿Cómo funciona?', 'Hacer el diagnóstico'] },
                wrinkles: { match: ['arruga', 'anti-edad', 'envejecimiento', 'firmeza', 'colágeno', 'lifting'], answer: '<strong>Rutina anti-edad ÉCLAT:</strong><br><br>1. <strong>Sérum Vitamina C 20%</strong> (19,90€)<br>2. <strong>Mascarilla LED Pro</strong> (49,90€) — luz roja<br>3. <strong>Stickers Anti-Arrugas</strong> (17,90€)', followUp: ['Añadir Sérum', 'Ver Stickers', 'Diagnóstico'] },
                hydration: { match: ['seca', 'deshidrat', 'hidrat', 'tirante'], answer: '<strong>Rutina hidratación:</strong><br><br>1. <strong>Steamer Facial Nano-Ion</strong> (29,90€)<br>2. <strong>Aceite Rosa Mosqueta</strong> (16,90€)<br>3. <strong>Parches Ojos Colágeno</strong> (12,90€)', followUp: ['Añadir Steamer', 'Ver Aceite Rosa', 'Diagnóstico'] },
                darkcircles: { match: ['ojera', 'bolsa', 'ojos hinchados', 'contorno', 'cansad'], answer: '<strong>Solución ojeras y bolsas:</strong><br><br>1. <strong>Ice Roller Cryo</strong> (9,90€)<br>2. <strong>Parches Ojos Colágeno</strong> (12,90€)<br>3. <strong>Mascarilla Ojos Vapor</strong> (9,90€)<br><br>Total: ¡solo <strong>32,70€</strong>!', followUp: ['Añadir Ice Roller', 'Ver Parches', 'Diagnóstico'] },
                glow: { match: ['apagad', 'luminosidad', 'brillo', 'mancha', 'pigment', 'tono'], answer: '<strong>Rutina luminosidad:</strong><br><br>1. <strong>Sérum Vitamina C 20%</strong> (19,90€)<br>2. <strong>Gua Sha Cuarzo Rosa</strong> (14,90€)<br>3. <strong>Mascarilla Colágeno Lifting</strong> (14,90€)', followUp: ['Añadir Gua Sha', 'Ver Sérum', 'Diagnóstico'] },
                ...
                shipping: { match: ['envío', 'entrega', 'cuánto tarda', 'enviar'], answer: 'Enviamos a toda <strong>Europa</strong>:<br><br>• <strong>Estándar</strong>: 7-14 días — gratis desde 49€<br>• <strong>Express</strong>: 5-10 días — 7,90€<br>• Seguimiento incluido', followUp: ['Devoluciones?', 'Pago?', 'Seguimiento'] },
                ...
                bestseller: { match: ['más vendido', 'popular', 'mejor', 'top'], answer: 'Top 3 más vendidos:<br><br>1. <strong>Mascarilla LED Pro</strong> (49,90€)<br>2. <strong>Gua Sha Cuarzo Rosa</strong> (14,90€)<br>3. <strong>Ice Roller Cryo</strong> (9,90€)', followUp: ['Ver LED', 'Ver Gua Sha', 'Diagnóstico'] },
        ...
        de: {
            ...
            responses: {
                acne: { match: ['akne', 'pickel', 'unreinheit', 'mitesser', 'pore', 'fettig'], answer: '<strong>ÉCLAT Anti-Akne-Routine:</strong><br><br>1. <strong>Sonic-Reinigungsbürste</strong> (29,90€)<br>2. <strong>Ultraschall-Scrubber</strong> (34,90€)<br>3. <strong>LED-Maske Pro</strong> (49,90€) — Blaulicht antibakteriell<br><br><a href="pages/guide-beaute.html#led" style="color:var(--color-secondary);">Klinische Studie lesen →</a>', followUp: ['LED-Maske hinzufügen', 'Wie funktioniert LED?', 'Diagnose starten'] },
                wrinkles: { match: ['falten', 'anti-aging', 'altern', 'straffung', 'kollagen', 'lifting'], answer: '<strong>ÉCLAT Anti-Aging-Routine:</strong><br><br>1. <strong>Vitamin C Serum 20%</strong> (19,90€)<br>2. <strong>LED-Maske Pro</strong> (49,90€) — Rotlicht<br>3. <strong>Anti-Falten-Sticker Nacht</strong> (17,90€)', followUp: ['Serum hinzufügen', 'Sticker ansehen', 'Diagnose'] },
                hydration: { match: ['trocken', 'dehydr', 'feucht', 'spannt'], answer: '<strong>Feuchtigkeitsroutine:</strong><br><br>1. <strong>Facial Steamer Nano-Ion</strong> (29,90€)<br>2. <strong>Hagebuttenöl</strong> (16,90€)<br>3. <strong>Kollagen-Augenpads</strong> (12,90€)', followUp: ['Steamer hinzufügen', 'Hagebuttenöl', 'Diagnose'] },
                darkcircles: { match: ['augenring', 'schwellung', 'geschwollen', 'augen', 'müde'], answer: '<strong>Augenringe & Schwellungen:</strong><br><br>1. <strong>Ice Roller Cryo</strong> (9,90€)<br>2. <strong>Kollagen-Augenpads</strong> (12,90€)<br>3. <strong>Dampf-Augenmaske SPA</strong> (9,90€)<br><br>Gesamt: nur <strong>32,70€</strong>!', followUp: ['Ice Roller hinzufügen', 'Augenpads', 'Diagnose'] },
                glow: { match: ['fahl', 'strahlen', 'glanz', 'flecken', 'pigment', 'teint'], answer: '<strong>Strahlkraft-Routine:</strong><br><br>1. <strong>Vitamin C Serum 20%</strong> (19,90€)<br>2. <strong>Rosenquarz Gua Sha</strong> (14,90€)<br>3. <strong>Kollagen Lifting-Maske</strong> (14,90€)', followUp: ['Gua Sha hinzufügen', 'Serum ansehen', 'Diagnose'] },
                ...
                shipping: { match: ['versand', 'lieferung', 'wie lange', 'senden'], answer: 'Versand in ganz <strong>Europa</strong>:<br><br>• <strong>Standard</strong>: 7-14 Werktage — ab 49€ kostenlos<br>• <strong>Express</strong>: 5-10 Werktage — 7,90€<br>• Sendungsverfolgung inklusive', followUp: ['Rückgabe?', 'Zahlung?', 'Sendungsverfolgung'] },
                ...
                bestseller: { match: ['bestseller', 'beliebt', 'beste', 'top'], answer: 'Top 3 Bestseller:<br><br>1. <strong>LED-Maske Pro</strong> (49,90€)<br>2. <strong>Rosenquarz Gua Sha</strong> (14,90€)<br>3. <strong>Ice Roller Cryo</strong> (9,90€)', followUp: ['LED ansehen', 'Gua Sha ansehen', 'Diagnose'] },
