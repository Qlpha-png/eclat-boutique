    ...
    const KB = {
        fr: {
            ...
            responses: {
                ...
                human: {
                    ...
                    answer: 'Je vous redirige vers notre équipe ! 🙋<br><br>• <strong>Email :</strong> <a href="mailto:contact@maison-eclat.shop" style="color:var(--color-secondary);">contact@maison-eclat.shop</a> (réponse sous 24h)<br>• <strong>Formulaire :</strong> <a href="pages/contact.html" style="color:var(--color-secondary);">Page contact →</a><br>• <strong>Instagram :</strong> @eclat.beaute (DMs ouverts)<br><br>Notre équipe vous répondra personnellement !',
        ...
        en: {
            ...
            responses: {
                ...
                human: { match: ['human', 'agent', 'real person', 'talk to someone', 'human support'], answer: 'I\'ll connect you with our team! 🙋<br><br>• <strong>Email:</strong> <a href="mailto:contact@maison-eclat.shop" style="color:var(--color-secondary);">contact@maison-eclat.shop</a> (reply within 24h)<br>• <strong>Form:</strong> <a href="pages/contact.html" style="color:var(--color-secondary);">Contact page →</a><br>• <strong>Instagram:</strong> @eclat.beaute (DMs open)<br><br>Our team will answer you personally!', followUp: ['FAQ', 'Shipping?', 'Returns?'] },
        ...
        es: {
            ...
            responses: {
                ...
                human: { match: ['humano', 'agente', 'persona real', 'hablar con alguien', 'soporte humano'], answer: '¡Te conecto con nuestro equipo! 🙋<br><br>• <strong>Email:</strong> <a href="mailto:contact@maison-eclat.shop" style="color:var(--color-secondary);">contact@maison-eclat.shop</a><br>• <strong>Formulario:</strong> <a href="pages/contact.html" style="color:var(--color-secondary);">Página de contacto →</a>', followUp: ['FAQ', 'Envío?', 'Devoluciones?'] },
        ...
        de: {
            ...
            responses: {
                ...
                human: { match: ['mensch', 'mitarbeiter', 'echte person', 'jemanden sprechen', 'menschlicher support'], answer: 'Ich verbinde Sie mit unserem Team! 🙋<br><br>• <strong>E-Mail:</strong> <a href="mailto:contact@maison-eclat.shop" style="color:var(--color-secondary);">contact@maison-eclat.shop</a><br>• <strong>Formular:</strong> <a href="pages/contact.html" style="color:var(--color-secondary);">Kontaktseite →</a>', followUp: ['FAQ', 'Versand?', 'Rückgabe?'] },
